;****************************************
;
; SH2 emulator 1.30 (ASM source part)
...
;      Bits 31 - 16 = HAVE TO STAY 0 (needed for opcode jump table)
...
bits 32
	...
	NOP_Table:
		dw SH2_NOP_CODE, SH2_NOP_CODE, SH2_NOP_CODE, SH2_NOP_CODE
		dw SH2_NOP_CODE, SH2_NOP_CODE, SH2_NOP_CODE, SH2_NOP_CODE
...
; IN:
; ebp = SH2 context pointer
; ecx = old PC based & updated (don't need to add 2)
; edi = cycles counter
; esi = new PC based & updated (don't need to add 2, ready for delay slot execution)
;
; OUT:
; nothing
...
DECLF SH2_Exec, 8
	...
	jbe near SH2_Cycles_Already_done
	...
	mov al, [ebp + SH2.Status]
	xor ecx, ecx
	test al, SH2_HALTED | SH2_FAULTED | SH2_RUNNING
	jnz near SH2_Cant_Run
...
; ecx = context pointer
; edx = manual reset flag (1 for manual, 0 for powerup)
;
; RETURN:
; 0  -> ok
; -1 -> error
...
DECLF SH2_Reset, 8
	...
	lea eax, [edi + 4]
	add esi, byte 4
	jnp near .error			; PC = odd address -> error
