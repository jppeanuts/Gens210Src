/**********************************************************/
/*                                                        */
/* SH2 emulator 1.30 (C source part)                      */
...
/* I needed exactly the same table so why bother to         */
/* rewrite enterely it ;)                                   */
/*                                                          */
/************************************************************/
...
void SH2_Init(SH2_CONTEXT *SH2)
{
	...
	if (!SH2_Initialised)
	{
		...
		for(i = 0; i < 0x400; i++)
		{
			...
			Set_SR_Table[i] = (i & 0x001) | (s << 8) | (il << 16) | (m << 25) | (q << 24);
