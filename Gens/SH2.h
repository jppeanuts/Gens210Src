/**********************************************************/
/*                                                        */
/* SH2 emulator 1.30 (Hearder part)                       */
...
UINT32 FASTCALL SH2_Set_PC(SH2_CONTEXT *sh2, UINT32 val);
UINT32 FASTCALL SH2_Set_SR(SH2_CONTEXT *sh2, UINT32 val);
UINT32 FASTCALL SH2_Set_GBR(SH2_CONTEXT *sh2, UINT32 val);
UINT32 FASTCALL SH2_Set_VBR(SH2_CONTEXT *sh2, UINT32 val);
UINT32 FASTCALL SH2_Set_PR(SH2_CONTEXT *sh2, UINT32 val);
UINT32 FASTCALL SH2_Set_MACH(SH2_CONTEXT *sh2, UINT32 val);
UINT32 FASTCALL SH2_Set_MACL(SH2_CONTEXT *sh2, UINT32 val);
